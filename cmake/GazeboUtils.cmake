...
if (VALID_DISPLAY)
  ...
  macro (gz_build_qt_tests)
   ...
   foreach(QTEST_SOURCE_file ${ARGN})
     ...
     QT4_WRAP_CPP(${BINARY_NAME}_MOC OPTIONS -DBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION -DBOOST_TT_HAS_OPERATOR_HPP_INCLUDED ${QTEST_HEADER_file} ${CMAKE_SOURCE_DIR}/gazebo/gui/QTestFixture.hh)
