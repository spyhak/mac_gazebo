...
if (VALID_DISPLAY)
  ...
  macro (gz_build_qt_tests)
   ...
   foreach(QTEST_SOURCE_file ${ARGN})
     ...
     QT4_WRAP_CPP(${BINARY_NAME}_MOC ${QTEST_HEADER_file} ${CMAKE_SOURCE_DIR}/gazebo/gui/QTestFixture.hh OPTIONS -DBOOST_TT_HAS_OPERATOR_HPP_INCLUDED -DBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION)
